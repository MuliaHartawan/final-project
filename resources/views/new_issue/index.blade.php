      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="row">
                <p><a href='/jawaban/{{ $pertanyaan->id }}'>{{ $pertanyaan->judul }}</a>
                  <p>
                    <p>{{ $pertanyaan->isi }}</p>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 text-right"><small>Tanya : {{ $pertanyaan->created_at }}<br>Post by : <a
                      href='#'>{{ $pertanyaan->user->name }}</a></small></div>
              </div>
