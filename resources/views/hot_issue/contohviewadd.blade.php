        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-10">
                      <div class="row">
                       ...
                       <div class="row"> 
                          <div class="col-md-12 text-right"><small>Tanya : 2020-06-01 17:00:00<br>Post by : <a href='#'>People Sanbercode</a></small><br><a href="#" class="btn btn-sm btn-warning"><i class="fa fa-comment"></i> Tulis Komentar</a></div>
                       </div>
                       <hr>
                       <ul>
                        ...
                        <a href='#anchor-jawaban' class="btn btn-warning btn-md"><i class='fa fa-edit'></i> Tulis Jawaban</a>
                     </div>
                   </div>
              ...
              <a href='#' class="btn btn-success btn-md">Terdapat 25 Jawban</a>
              <br>
              <br>
